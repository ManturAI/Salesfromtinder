...
function PageContent() {
  ...
  const VIDEO_URL = "https://www.figma.com/board/fFJuJYSS0B0UBylik2OKKD/%D0%92%D0%B8%D0%94%D0%95%D0%9D%D0%98%D0%95?node-id=0-1&p=f&t=RjgSySUbpX8U82w1-0".toLowerCase();
    ...
    <div className="relative z-10 mx-auto max-w-2xl px-4 py-10">
      ...
      <div className="mt-8 space-y-3">
        <a
          ...
          className="group block w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow см hover:border-white/20 hover:bg-white/10 transition"
        >
          ...
          <span className="flex-1">
            ...
            <span className="block text-sm text-white/70">Основные шаги после встречи</span>
          </span>
        </a>
