...
function PageContent() {
  ...
  const VIDEO_URL = "https://www.figma.com/board/fFJuJYSS0B0UBylik2OKKD/%D0%92%D0%98%D0%94%D0%95%D0%9D%D0%98%D0%95?node-id=0-1&p=f&t=RjgSySUbpX8U82w1-0".toLowerCase();
      ...
      <div className="mt-8 space-y-3">
        ...
        >
          ...
          <span className="flex-1">
            ...
            <span className="block text-sm text-white/70">Ключевые приёмы закрытия сделки</span>
          </span>
        </a>
